using SMARTFI.OrionContextBroker.Client;
using SMARTFI.OrionContextBroker.Client.Models;
using SMARTFI.OrionContextBroker.Client.Types;
using System;
...
namespace SMARTFI.OrionContextBroker.Client.Tests
{
    class Program
    {
